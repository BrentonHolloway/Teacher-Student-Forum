                                ...
                                <form onSubmit={this.handleSubmit}>
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-6">
                                            <input type="text" name="subjectName" id="subjectName" className="form-control" value={this.state.subjectName} onChange={this.handleFormChange}/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-6">
                                            <textarea name="description" id="description" className="form-control" rows="7" value={this.state.description} onChange={this.handleFormChange}/>
                                        </div>
                                    </div>
